            ...
            <div className=":bg-gray-800 shadow-lg rounded-lg p-8">
              ...
              <section className="mb-8">
                ...
                <div className="mb-4">
                  ...
                  <p className="text-gray-600 text-gray-400">Laboremus Uganda | 2022 - Present</p>
                ...
                <div className="mb-4">
                  ...
                  <p className="text-gray-600 text-gray-400">Valuer Space Inc. | 2022 - Present</p>
                  <ul className="list-disc list-inside mt-2">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-gray-400">Renga Technologies – Kampala, Uganda | 2021 - 2022</p>
                  <ul className="list-disc list-inside mt-2">
              ...
              <section className="mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-gray-400">Clerk International University | 2020 - 2021</p>
                </div>
                <div>
                  <h3 className="text-xl font-medium">Bachelor of Science in Chemical Engineering</h3>
                  <p className="text-gray-600 text-gray-400">Kyambogo University | 2014 - 2018</p>
                </div>
              </section>
